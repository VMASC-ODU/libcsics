...
namespace csics::io::compression {
    ...
    struct CompressionResult {
        std::size_t compressed; // How many bytes were put into the compressed buffer
        std::size_t input_consumed; // How many bytes were consumed from the input buffer
    ...
    class ICompressor {
        public:
            ...
            virtual CompressionResult compress_partial(BufferView in, BufferView out) = 0;
            virtual CompressionResult compress_buffer(BufferView in, BufferView out) = 0;
